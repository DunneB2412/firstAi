...
class Gamestate:
    ...
    MAX_TICKS = 3000  # maximum amount of turns before Pacman dies automatically
    ...
    def tick(self):
        ...
        if self._tick == self.MAX_TICKS:
            ...
            print(f'WARNING: max number of ticks reached ({self.MAX_TICKS}) pacman was destroyed, Big oof')
